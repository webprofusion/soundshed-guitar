...
class ResourceLibrary
{
  public:
    ...
    [[nodiscard]] std::vector<LibraryResource> GetResourcesByCategory(const std::string& type,
    ...
    static bool PutInStore(storage::JsonStore& store, const LibraryResource& resource,
