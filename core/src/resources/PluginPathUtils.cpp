...
std::string_view PluginFormatDisplayName(PluginFormat format)
{
    switch (format)
    {
        case PluginFormat::VST3: return "VST3 (.vst3)";
        case PluginFormat::AudioUnit: return "Audio Unit (.component)";
        case PluginFormat::LV2: return "LV2 (.lv2)";
        case PluginFormat::CLAP: return "CLAP (.clap)";
        case PluginFormat::AAX: return "AAX (.aaxplugin)";
        case PluginFormat::VST2: return "VST2 (.dll/.vst)";
        case PluginFormat::Unknown: break;
    }
    return {};
}
