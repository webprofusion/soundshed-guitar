...
{
  public:
    LeakyReLUActivation(float negativeSlope = 0.01f) : mNegativeSlope(negativeSlope)
    {
    }
 ...
 */
inline void ApplyWaveNetLayerActivation(Eigen::MatrixXf& z, long channels, int numFrames, Activation* activation,
                                        bool gated)
{
    if (!gated)
    {
