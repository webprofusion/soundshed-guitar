...
int main()
{
    ...
    try
    {
        ...
        const auto recordError = [&errors](std::string message) { errors.push_back(std::move(message)); };
            ...
            for (const auto& preset : presetsJson)
            {
                ...
                for (const auto& node : graph["nodes"])
                {
                    ...
                    if (nodeType == "amp_nam")
                    {
                        ...
                        {
                            recordError("Preset " + presetId + " node " + nodeId +
                        ...
                        {
                            recordError("Preset " + presetId + " node " + nodeId +
                                        " references unknown NAM model: " + resourceId);
                        }
                    }
                    else if (nodeType == "cab_ir")
                    {
                        ...
                        {
                            recordError("Preset " + presetId + " node " + nodeId +
                                        " references unknown IR: " + resourceId);
                        }
                    }
                }
            }
