...
template <typename T> void GenerateSine(std::vector<T>& buffer, double frequency, double sampleRate, double amplitude)
{
...
PresetRunResult RunPreset(guitarfx::SignalGraphExecutor& executor, guitarfx::ResourceLibrary& library,
                          const guitarfx::Preset& preset)
{
