...
BenchmarkResult BenchmarkDirectNAM(const fs::path& modelPath, const std::string& modelName,
...
BenchmarkResult BenchmarkGraphNAM(const fs::path& resourcesDir, const fs::path& modelPath, const std::string& modelName,
                                  const char* ampType, const BenchmarkConfig& config)
{
    BenchmarkResult result;
...
void RunMultiConfigBenchmark(const fs::path& resourcesDir, const fs::path& modelPath, const std::string& modelName)
{
    std::cout << "\n";
    std::cout << "╔══════════════════════════════════════════════════════════════════╗\n";
    ...
    case guitarfx::simd::SimdLevel::AVX2:
        std::cout << "AVX2";
        break;
    case guitarfx::simd::SimdLevel::AVX:
        std::cout << "AVX";
        break;
    case guitarfx::simd::SimdLevel::SSE4:
        std::cout << "SSE4";
        break;
    case guitarfx::simd::SimdLevel::SSE2:
        std::cout << "SSE2";
        break;
    default:
        std::cout << "Scalar";
    ...
    for (const auto& tc : configs)
    {
        ...
        std::cout << std::right << std::setw(10) << std::fixed << std::setprecision(1) << standardResult.realTimeFactor
                  << "x │ ";
