...
TestResult TestDSPPerformanceStatsPopulation()
{
    ...
    try
    {
        ...
        {
            result.message =
                "Initial totalProcessingTimeUs is negative: " + std::to_string(initialStats.totalProcessingTimeUs);
            return result;
        }
        ...
        {
            result.message =
                "Initial dspLoadPercent out of range [0,100]: " + std::to_string(initialStats.dspLoadPercent);
            return result;
        }
        ...
        if (updatedStats.totalProcessingTimeUs <= initialStats.totalProcessingTimeUs)
        {
            result.message = "totalProcessingTimeUs did not increase after processing: initial=" +
                             std::to_string(initialStats.totalProcessingTimeUs) +
                             ", updated=" + std::to_string(updatedStats.totalProcessingTimeUs);
            return result;
        }
        ...
        {
            result.message = "totalProcessingTimeUs is not positive after processing: " +
        ...
        {
            result.message =
                "Updated dspLoadPercent out of range [0,100]: " + std::to_string(updatedStats.dspLoadPercent);
            return result;
        }
    ...
    try
    {
        ...
        if (statsAfterReset.totalProcessingTimeUs != statsAfterProcessing.totalProcessingTimeUs)
        {
            result.message = "totalProcessingTimeUs changed after reset: before=" +
                             std::to_string(statsAfterProcessing.totalProcessingTimeUs) +
                             ", after=" + std::to_string(statsAfterReset.totalProcessingTimeUs);
            return result;
        }
        ...
        {
            result.message =
                "realTimeUs changed after reset: before=" + std::to_string(statsAfterProcessing.realTimeUs) +
                ", after=" + std::to_string(statsAfterReset.realTimeUs);
            return result;
        }
...
TestResult TestMultiPresetMixerPerformanceStats()
{
    ...
    try
    {
        ...
        {
            result.message =
                "Initial totalProcessingTimeUs should be 0, got: " + std::to_string(initialStats.totalProcessingTimeUs);
            return result;
        }
        ...
        if (updatedStats.totalProcessingTimeUs <= 0.0)
        {
            result.message = "totalProcessingTimeUs should be positive after processing, got: " +
                             std::to_string(updatedStats.totalProcessingTimeUs);
            return result;
        }
...
TestResult TestMultiPresetMixerAutoLevelOutputTargetsProtectionCeiling()
{
    ...
    try
    {
        ...
        {
            result.message =
                "Auto-level output did not converge to the protection ceiling: peak=" + std::to_string(peak) +
                ", ceiling=" + std::to_string(expectedCeiling);
            return result;
        }
