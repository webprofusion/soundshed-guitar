...
export const FEATURE_DEFINITIONS: FeatureDefinition[] = [
  ...
  {
    id: Features.PracticeTool,
    key: "features.practiceTool.enabled",
    label: "Practice Tool",
...
const JAM_PANEL_FEATURE_IDS: FeatureId[] = [Features.Jam, Features.RiffLibrary, Features.PracticeTool];
