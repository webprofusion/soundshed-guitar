#include "presets/PresetStorageV2.h"
...
namespace namguitar
{
  ...
  std::string PresetStorageV2::SerializeToJson(const PresetV2& preset)
  {
    nlohmann::json json;
  ...
  std::optional<PresetV2> PresetStorageV2::DeserializeFromJson(const std::string& jsonStr)
  {
    try
    {
  ...
  bool PresetStorageV2::SaveToFile(const PresetV2& preset, const std::filesystem::path& path)
  {
    try
    {
  ...
  std::optional<PresetV2> PresetStorageV2::LoadFromFile(const std::filesystem::path& path)
  {
    try
    {
  ...
  std::vector<PresetV2> PresetStorageV2::LoadAllFromDirectory(const std::filesystem::path& directory)
  {
    std::vector<PresetV2> presets;
  ...
  void PresetStorageV2::SaveAllToDirectory(const std::vector<PresetV2>& presets, const std::filesystem::path& directory)
  {
