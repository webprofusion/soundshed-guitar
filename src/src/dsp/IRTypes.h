...
namespace namguitar
{
  ...
  constexpr const char* GetIRQualityName(IRQuality quality)
  {
    switch (quality)
    {
      case IRQuality::Economy:  return "Economy";
      case IRQuality::Standard: return "Standard";
      case IRQuality::High:     return "High";
      case IRQuality::Full:     return "Full";
  ...
  constexpr IRQuality GetIRQualityFromInt(int value)
  {
    switch (value)
    {
      case 0:  return IRQuality::Economy;
      case 1:  return IRQuality::Standard;
      case 2:  return IRQuality::High;
      case 3:  return IRQuality::Full;
      default: return IRQuality::Standard;
    }
  }
  ...
  constexpr int GetIntFromIRQuality(IRQuality quality)
  {
    switch (quality)
    {
      case IRQuality::Economy:  return 0;
      case IRQuality::Standard: return 1;
      case IRQuality::High:     return 2;
      case IRQuality::Full:     return 3;
      default:                  return 1;
    }
  }
