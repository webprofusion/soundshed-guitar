...
# Keep the Catch2 test runner focused on Catch2 tests only.
set(TestFiles
    "${CMAKE_CURRENT_SOURCE_DIR}/tests/Catch2Main.cpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/tests/PluginBasics.cpp"
)
...
# Ensure WebView2 headers are available when tests compile JUCE web browser sources.
if (WIN32)
...
target_compile_definitions(Tests PUBLIC
    ...
    GUITARFX_TEST_RESOURCES_DIR="${CMAKE_CURRENT_SOURCE_DIR}/assets"
)
