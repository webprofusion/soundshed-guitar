...
list (FILTER AssetFiles EXCLUDE REGEX "/node_modules/")
list (FILTER AssetFiles EXCLUDE REGEX "/ts/")
list (FILTER AssetFiles EXCLUDE REGEX "/package(-lock)?\\.json$")
list (FILTER AssetFiles EXCLUDE REGEX "/tsconfig\\.json$")
