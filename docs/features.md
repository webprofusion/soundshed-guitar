...
| `eq_graphic` | Graphic Equalizer | Profile-owned 5/10-band Bass, Guitar, and General Purpose configurations. Each band has `bandNEnabled`, `bandNGain`, `bandNFreq`, and `bandNQ`. |
